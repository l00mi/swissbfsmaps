// Sgvizler - https://code.google.com/p/sgvizler/
...
(function (window, undefined) { // trick: safekeep 'undefined', and minify.
    ...
    S.registry = (function () {
        ...
        return {
             ...
             * charts.
             * @method getChartModules
             * @protected
             * @return {Array} (an array of strings)
             * @since 0.6.0
             **/
            getChartModules: function () {
        ...
        var util = S.util,
            ...
            */
            ...
            insertFrom = function () {
                var i, len,
                    from = "";
                for (i = 0, len = queryOptions.froms.length; i < len; i += 1) {
                             ...
                             ['p', null,
                              [
                                  ...
                                  ' version ' + S.core.VERSION +
                                      ' (c) 2011&ndash;2012 Martin G. Skj&#230;veland.'
                              ]
                             ]
                         ]
                        ]
    ...
    S.visualization = (function () {
        ...
        C.DraculaGraph = charts.add(modSC, "DraculaGraph",
            function (data, chartOpt) {
                ...
                $(this.container).empty();
                renderer = new Dracula.Graph.Renderer.Raphael(this.container, graph, opt.width, opt.height, {"noderadius": opt.nodeheight * opt.noderadius});
                renderer.draw();

                this.fireListener('ready');
            },
            { Dracula: S.core.VERSIONFOLDER + 'raphael-dracula.js' }
            );
        ...
        C.Table = charts.add(modSC, "Table",
            function (data, chartOpt) {
                ...
                table = S.util.createHTMLElement('table', null, rows);
